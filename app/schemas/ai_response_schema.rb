...
class AiResponseSchema < RubyLLM::Schema
  string :order_advice,
         description: "One sentence instruction to recommend user about the position inside a resume. With a specific job title and JD, most relevant project or work experience (if any) needs to be near the top of the resume page. Use a simple markdown, but cannot be a table or pipes"
